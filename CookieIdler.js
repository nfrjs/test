...
const cookietName = [
	...
	["Gilles-Cookie Paill�","liver","Mathmatically Illegal Cookie","! [ Snakey Snickerdoodles ] !","Nerdy as f Cookie",":exCookie:","JS-Formed ellipsis Cookie","SkyXCookie","Weierstra??? Cookie Spiral","Exponential Cookie","ouo cookie","Orteil � Cookie"],
...
const bach2 = ["Clicktopia","Tootsie Roll Machine","100% Sustainable","Break the core","Age of Internet","Keynesian Cookinomics","Balance of Faith","Alakazamd","Cosmic Mapping","Polytranselementation","H?e? ?C?o?m?e?s?","Thyme Pararegano","New Standard Model of Cookie and Flour","Total Enlightenment","Devil\'s Gambit","Apollonian Gasket","Infinite Theorycraft","Is there enough worlds?","Cardinal Synapsis"];
const bach3 = ["Thumbs, Phalanges, Metacarpals","Ruler of the Ancients","Green Pasture lays live","Dysonian Society","Automatal Hysteria","New Neohyperglobalization Order","The Lord\'s Likeliness","Shaspie Colupis","Multiverse Ramble","With matter comes Cookies","I???n??? ???t???h???e??? ???e???y???e???s??? ???o?`?f??? ???t???h?^?e??? ???b???e???h???o???l???d???e?`?r???","Thyme Sagaporal Nutmegstant","Unified Complete Theory of the Cookieverse","O thy energy of sky, bring fourth the light rays","Gamber\'s Last Bet","C_n := (C_n-1 ? (2+C_n-1))/3, where C_0 := [0,1]","I bring fourth reincarnation of reality","Lost your Cosmic Cookies?","I declare thee on all ye inferiors. Despair before me, I am the Ozymandias"];
...
const sach = ["Neophyte","Acolyte","Adept","Harry Cookier","Master of Spells","Lazy Wizard","Gambler Wizard","Ascendant Wizard","Mass Miner Wizard","Explorer Wizard","Mogul Wizard","Impatient Wizard","Very Sweet Wizard","??????!"];
var featAchCat;
